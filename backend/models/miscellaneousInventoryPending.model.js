...
const schema = new Schema({
    ...
    physical: { type: Number, min: 0, default: 0 }, //inventario fisico
    minimumStock: { type: Number, min: 0, default: 0 }, // Mínimo de Stock recomendado para ese producto en esa tienda
...
module.exports = mongoose.model('InventoryMiscellaneousPending', schema);