...
const schema = new Schema({     
    ...
    recordType: { type: String, required: true},    // El tipo de registro (creacion o actualizacion)
    modification: { type: String },                 // El tipo de modificacion (lo que sea que se modifico)
    modificationUser: { type: 'ObjectId', ref: 'Agency'},   // El usuario que realizó la modificación
    ...
    serial: { type: String, required: true},     // Serial
...
module.exports = mongoose.model('AssetsRecord', schema);