...
var pendingValeSchema = new Schema({    //  Modelo provisional del crédito
    products: [],                 //  Productos
...
const schema = new Schema({
    ...
    pendingPayment: { type: pendingValeSchema },       //  Venta pendiente (si la hay)
...
module.exports = mongoose.model('ValeClient', schema);