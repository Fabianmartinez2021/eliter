...
const schema = new Schema({
    ...
    type: { type: Number, default: 5 },                     //  Tipo de registro, Detal, Mayor, Abono o Crédito
...
schema.plugin(AutoIncrement, {id:'sales_fiscal_order_seq',inc_field: 'order'});
...
module.exports = mongoose.model('SalesFiscal', schema);