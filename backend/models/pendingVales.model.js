...
const schema = new Schema({
    ...
    documentType: { type: String, default:'V'}, //  Si es V, J, E,G, P, R
    document: { type: String},
    names: { type: String},
    businessName: { type: String }, //  Nombre del negocio
    clientType: { type: String},   //  Si es revendedor independiente, restaurant, charcuteria, etc
    taxpayer: { type: String},     //  Tipo de contribuyente: Especial y Ordinario
    phone:{ type: String, default:'' },
    autorize: { type: String, default:'' },
    address: { type: String},      
    ...
    order: { type: Number},    //  Numero de identificacion
...
module.exports = mongoose.model('pendingVales', schema);