...
import { miscellaneoumiscellaneousActions, sActions, userActions } from '../../actions';
...
function DepartureMiscellaneousListPage() {
    ...
    const dataDeparture = useSelector(state => state.departureMiscellaneous.data);
  
    const loadingPage = useSelector(state => state.departureMiscellaneous.loading);
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            wrap: true,
            cell: row => row.agency && row.agency.name ? row.agency.name : 'Sin sucursal'
        },
        {
            name: 'Nombres',
            selector: 'names',
    ...
    const getDataTable = (page) => {
        dispatch(departureMiscellaneousActions.dataTable(getUserData(), page, perPageSelect == 0 ? perPage : perPageSelect, direction, {}, false));
    }

    //Paginar
    const handlePageChange = async (page) => {
        dispatch(departureMiscellaneousActions.dataTable(getUserData(), page, perPageSelect == 0 ? perPage : perPageSelect, direction, filters ? filters: {}, false));
    };
    ...
    const handleSort = (column, sortDirection) => {
        ...
        setDirection(sort);
        dispatch(departureMiscellaneousActions.dataTable(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, sort, filters ? filters: {}, false));
    };

    //Cambiar cantidad de filas
    const handlePerRowsChange = async (newPerPage, page) => {
        setPerPageSelect(newPerPage);
        dispatch(departureMiscellaneousActions.dataTable(getUserData(), page, newPerPage, direction, filters ? filters: {}, false));
    };
    ...
    const onFilterData = (data, e) => {
        ...
        setFilters(data);
        dispatch(departureMiscellaneousActions.dataTable(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, direction, data, false));
    }
                    ...
                    <div className="flex-column flex-md-row p-3">
                        ...
                        <div className="d-flex justify-content-between" style={{padding:"4px 16px 4px 24px"}}>
                            ...
                            <div>
                                ...
                                <Button id="add" onClick={()=>history.push('/departure-miscellaneous')} className="btn-round btn-icon" color="primary">
                                    ...
                                    <FormGroup className="mr-3">
                                        <select className='form-control' name="type"
                                            ref={register}>
                                                ...
                                                {/* <option key="1" name="1" value="1">Uso</option> */}
                                                <option key="2" name="2" value="2">Traslado Entre Tiendas</option>
                                                <option key="3" name="3" value="3">Desechos</option>
                                        </select>
                                    </FormGroup>
                                    <FormGroup className="mr-3">
                                        <input
...
export default DepartureMiscellaneousListPage;