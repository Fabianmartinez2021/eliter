...
function TelesalesPendingPaymentsPage() {
	...
	const onFilterData = (data, e) => {
		...
		// Para este caso siempre se buscarán sólo las televentas
		data.telesales = true;
				...
				<div id="page-content-wrapper">
					...
					<div className="flex-column flex-md-row p-3">
						...
						<div className="d-flex justify-content-between" style={{padding:"4px 16px 4px 24px"}}>
							<div className="align-self-center">
								<h3 style={{ fontWeight:'bold',fontStyle: 'italic',  marginBottom: '0'}}>Cuentas por cobrar (Solo televentas)</h3>
							</div>
							<div>
						...
						{/* Filtros */}
						{
							(((user.role != 4) && ((user.role == 3) && (filters.agency == user.agency.id))) || (user.role == 1))  &&  
								<>
									<div className="align-self-right">
...
export default TelesalesPendingPaymentsPage;