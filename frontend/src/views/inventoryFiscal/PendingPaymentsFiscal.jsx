...
function PendingPaymentsFiscalPage() {
    ...
    const loadingPage = useSelector(state => state.pendingPaymentsFiscal.loading);
    ...
    const getDataTable = (page) => {
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), page, perPageSelect == 0 ? perPage : perPageSelect, direction, {}));
    }

    //Paginar
    const handlePageChange = async (page) => {
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), page, perPageSelect == 0 ? perPage : perPageSelect, direction, filters ? filters: {}));
    };
    ...
    const handleSort = (column, sortDirection) => {
        ...
        setDirection(sort);
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, sort, filters ? filters: {}));
    };

    //Cambiar cantidad de filas
    const handlePerRowsChange = async (newPerPage, page) => {
        setPerPageSelect(newPerPage);
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), page, newPerPage, direction, filters ? filters: {}));
    };
    ...
    const onFilterData = (data, e) => {
        ...
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, direction, data));
    };
    ...
    const exportExcel = () => {
        ...
        dispatch(pendingPaymentsFiscalActions.dataTable(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, direction, filters, true));
    }
    ...
    const exportToExcel = (data, filename = 'CunetasEspecialesporcobrar.xlsx') => {
        const worksheet = XLSX.utils.json_to_sheet(data);
        const workbook = XLSX.utils.book_new();

        XLSX.utils.book_append_sheet(workbook, worksheet, 'Cuentas especiales por cobrar');
...
export default PendingPaymentsFiscalPage;